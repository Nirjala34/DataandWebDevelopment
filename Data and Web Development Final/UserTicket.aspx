    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container py-4">
                    ...
                    <div class="row g-3 text-white align-items-end">
                        ...
                        <div class="col-md-3">
                            <label for="periodDropDown" class="form-label fw-bold"><i
                                    class="bi bi-calendar-event me-2"></i>Filter:</label>
                            <asp:DropDownList ID="DropDownListPeriod" runat="server" AutoPostBack="False"
                                CssClass="form-select dropdown-highlight"
                                style="background: rgba(255,255,255,0.05); color: white; border: 1px solid rgba(255,255,255,0.1);">
            ...
            <asp:Panel ID="PanelResults" runat="server" Visible="false">
                ...
                <asp:FormView ID="FormView1" runat="server" DataSourceID="SqlDataSourceUserDetails"
                    CssClass="w-100 mb-4">
                    <ItemTemplate>
                            ...
                            <div class="card-body p-4 d-flex align-items-center">
                                <div>
                                    <h2 class="text-white fw-bold mb-1"
                                        style="font-size: 2.2rem; letter-spacing: -0.5px;">
                                        <%# Eval("NAME") %>
                                    </h2>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField DataField="BOOKINGTIME" HeaderText="Booking Date & Time"
                                    SortExpression="BOOKINGTIME" HeaderStyle-CssClass="ps-4"
                                    ItemStyle-CssClass="ps-4" />
