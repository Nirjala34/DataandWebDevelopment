        ...
        <div class="container py-4">
            ...
            <div class="card glass-card mb-4">
                ...
                <div class="card-body p-4">
                    <div class="row g-3 text-white">
                        <div class="col-md-6">
                            <label class="filter-label fw-bold"><i class="bi bi-building me-1"></i>Select Active
                                Theater:</label>
                            <asp:DropDownList ID="DropDownListTheater" runat="server" AutoPostBack="True"
                                ...
                                <asp:ListItem Value="-1">Select Active Theater</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="card glass-card overflow-hidden transition-all hover-scale"
                ...
                <div class="card-header text-white"
                    ...
                    <h5 class="mb-0 fw-semibold"><i class="bi bi-calendar3 me-2" style="color: var(--neon-cyan);"></i>
            ...
            <asp:SqlDataSource ID="SqlDataSourceMoviesGrid" runat="server"
                ...
                <SelectParameters>
                    <asp:ControlParameter ControlID="DropDownListTheater" Name="THEATERID" PropertyName="SelectedValue"
